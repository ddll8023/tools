...
from toolbox_backend.integrations.mineru import build_convert_command, get_runtime_env
...
from toolbox_backend.modules.markdown_document.tables import html_tables_to_markdown
from toolbox_backend.core.logging import setup_logger
from toolbox_backend.schemas.response import ErrorCode
from toolbox_backend.modules.pdf_to_markdown.schemas import ConvertResponse, GetProgressResponse
...
from toolbox_backend.modules.pdf_to_markdown.result import read_deep_status, write_status_atomic
...
def _run_mineru_convert(task_id: str, pdf_path: str, task_dir: str):
    ...
    try:
        ...
        env = get_runtime_env()
        convert_command = build_convert_command(pdf_path, mineru_out)
