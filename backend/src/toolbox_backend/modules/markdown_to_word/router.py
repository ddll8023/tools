...
from toolbox_backend.modules.markdown_to_word.schemas import ConvertResponse, DownloadRequest
from toolbox_backend.modules.markdown_to_word import service as services_markdown_to_word
from toolbox_backend.core.logging import setup_logger

logger = setup_logger(__name__)

router = APIRouter(prefix="/tools/markdown-to-word", tags=["markdown-to-word"])
