...
from toolbox_backend.modules.markdown_to_word.schemas import ConvertResponse
from toolbox_backend.core.errors import ServiceException
from toolbox_backend.integrations.libreoffice import convert_to_doc
from toolbox_backend.infrastructure.files import safe_filename
from toolbox_backend.core.logging import setup_logger
from toolbox_backend.modules.markdown_document.docx import render_markdown_to_docx
from toolbox_backend.modules.markdown_document.source import (
    MarkdownInputError,
    MarkdownSource,
...
def convert_markdown_to_word(
    ...
    try:
        ...
        if selected_format == "doc":
            ...
            convert_to_doc(docx_path, output_path, task_dir, timeout=CONVERT_TIMEOUT)
